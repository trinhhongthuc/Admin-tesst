...
export default function TableManagerAccount(props) {
          ...
          {tableData.map((prop, key) => {
            return (
              <TableRow key={key} className={classes.tableBodyRow}>
                ...
                <TableCell className={classes.tableCell} key={key}>
                  {props.tableHeadAction == true ? (
                    <Link to={`/admin/account/detail-account/${prop.uid}`}>
                      <Button
                        color="warning"
...
TableManagerAccount.defaultProps = {
  tableHeaderColor: "gray",
};

TableManagerAccount.propTypes = {
